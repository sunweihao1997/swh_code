...
file_path = '/home/sun/wd_14/data/data/download_data/data/analysis_data/'
...
def main():
    ...
    plot_diff_slp_wind(diff_slp=gaussian_filter(file_var['pa'].data, sigma=1.05), left_title='1901-1955 Linear Trend', right_title='dswsc', out_path=out_path, pic_name="ERL_fig_Response_JJA_BTAL_BTALnEU_top_rad_linear_trend.pdf", level=level2, pvalue=None)
