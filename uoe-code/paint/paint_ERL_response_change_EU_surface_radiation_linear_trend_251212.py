'''
2025-11-27
This script is to calculate the linear trend of top radiation over Europe area between BTAL and BTALnEU
'''
import xarray as xr
import numpy as np
import os
...
file_path = '/home/sun/wd_14/data/data/download_data/data/Supplement_Data_send_by_Massimo/'

file_var    = xr.open_dataset(file_path + 'cesm_allf_fixEU_fns_trend_jja.nc')
#print(psl_btal)
...
def main():
    ...
    level2 = np.array([-5, -4, -3, -2.5, -2, -1.5, -1, -0.5, -0.25, 0.25, 0.5, 1, 1.5, 2, 2.5, 3, 4, 5])

    plot_diff_slp_wind(diff_slp=gaussian_filter(file_var['pa'].data, sigma=1.05), left_title='1901-1955 Linear Trend', right_title='dswsc', out_path=out_path, pic_name="ERL_fig_Response_JJA_BTAL_BTALnEU_surface_rad_linear_trend.pdf", level=level2, pvalue=None)
