...
def main():
    ...
    schedule.every().monday.at("17:00", shanghai_tz).do(run_screening_job)
    schedule.every().tuesday.at("17:00", shanghai_tz).do(run_screening_job)
    schedule.every().wednesday.at("17:00", shanghai_tz).do(run_screening_job)
    schedule.every().thursday.at("17:00", shanghai_tz).do(run_screening_job)
    schedule.every().friday.at("17:00", shanghai_tz).do(run_screening_job)

    print("✅ Scheduler started successfully.")
    print("The script will run every workday (Mon-Fri) at 17:00 Shanghai time.")
