...
def get_stock_data(stock_code: str, period: str = "daily", start_date: str = "20220101", end_date: str = "20251231") -> Optional[pd.DataFrame]:
    """
...
def main():
    ...
    # plot_vcp_analysis(df, vcp_result, breakout_signal, stock_to_test)
