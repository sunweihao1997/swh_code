...
#
#stock_hk_spot_em_df.to_excel("/home/sun/data/other/real_time_hk_mainboard.xlsx", index=False)

spot_df = pd.read_excel("/home/sun/data/other/real_time_hk_mainboard.xlsx", dtype={"代码": str})
...
file_path = f"/home/sun/data/other/stock_percentile/52week_percentile_output_{today_str}_HK.xlsx"
