...
Note: It is the Tencent version of the script, using Tencent cloud
'''
...
spot_df.to_excel(f"/home/ubuntu/stock_data/all_stock_realtime/real_time_{current_date}.xlsx", index=False)

spot_df = pd.read_excel(f"/home/ubuntu/stock_data/all_stock_realtime/real_time_{current_date}.xlsx", dtype={"代码": str})
...
file_path = f"/home/ubuntu/stock_data/stock_percentile/52week_percentile_output_{current_date}.xlsx"
