...
file_path = '/home/sun/data/liuxl_sailing/SD3/'
...
#print(f0_u['time'].data[:48])
axs.plot(np.linspace(0, 47, 48), ws10m_2day)

axs.set_xticks(range(0, 47, 3))

axs.set_title('Tianji', loc='right', fontsize=20)
axs.set_title('Start at 07-20 00:00', loc='left', fontsize=20)

axs.set_ylim((0, 30))

#axs.set_xlabel(str_t)
plt.savefig('/home/sun/paint/liuxl_sail/Xiamen_harbour_DuSuRui_20230727_20230728_ws10m_timeseries_Tianji.png')
