'''
2024-5-2
This script is to calculate the EOF for the 20-70 band-pass land precipitation
'''
import xarray as xr
import numpy as np
...
# ========= File Information ===========
f0  =  xr.open_dataset('/home/sun/data/process/analysis/AerChem/20-70_pr_MJJAS_multiple_model_result.nc')
...
ncfile.attrs['description'] = 'Created on 2024-5-2 by cal_AerChemMIP_EOF_analysis_20_70_240502.py. This file save the 20-70 bandpass precipitation EOF1 result for all the three experiments.'
ncfile.to_netcdf(out_path + 'AerchemMIP_Asia_EOF_land_summertime_20-70_precipitation_hist_SSP370_NTCF.nc')  