...
2024-12-4
The new edition means using new onset date file
'''
import os
import numpy as np
import xarray as xr
...
if __name__ == '__main__':
    ...
    print(len(early_years)) ; print(len(late_years))
    ...
    ncfile.attrs['description'] = 'This is new type of ERA5_monsoon_onset_climate_early_late_pressure_variables_composite_average_monthly.nc, as the onset date file using new one. Relevant script is /home/sun/swh_code/calculate/cal_Anomaly_onset_pressure_diagnose_climatology_new_241204.py'
    ncfile.to_netcdf("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_monsoon_onset_climate_early_late_pressure_variables_composite_average_monthly_new.nc")