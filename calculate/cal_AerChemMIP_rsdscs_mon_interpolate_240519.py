...
data_path0    = '/data/AerChemMIP/process/post-process/rsdscs/'

interp_path0  = '/data/AerChemMIP/process/post-process/rsdscs_samegrid/'
...
variable_list  =  ['ts',] # All of the above is wet_day
