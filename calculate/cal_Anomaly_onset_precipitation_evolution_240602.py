...
# data about OLR
olr_bandpass_file = xr.open_dataset("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_tp_bandpass_filter_30_80.nc").sel(lat=slice(15, 10), lon=slice(80, 90))
olr_bandpass_file2= xr.open_dataset("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_tp_bandpass_filter_30_80.nc").sel(lat=slice(15, 10), lon=slice(80, 87))
