...
axs[0].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[0, 0:10], axis=0), axis=0),     color='k', marker='s',    lw=1.5, markersize=5, alpha=1, label = "udT")
axs[0].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[1, 0:10], axis=0), axis=0),     color='r', marker='^',    lw=1.5, markersize=5, alpha=1, label = "u'dT")
axs[0].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[2, 0:10], axis=0), axis=0),     color='b', marker='X',    lw=1.5, markersize=5, alpha=1, label = "udT'")
axs[0].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[3, 0:10], axis=0), axis=0),     color='grey', marker='X', lw=1.5, markersize=5, alpha=1, label = "u'dT'")
...
axs[1].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[0, 12:22], axis=0), axis=0),     color='k', marker='s',    lw=1.5, markersize=5, alpha=1, label = "udT")
axs[1].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[1, 12:22], axis=0), axis=0),     color='r', marker='^',    lw=1.5, markersize=5, alpha=1, label = "u'dT")
axs[1].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[2, 12:22], axis=0), axis=0),     color='b', marker='X',    lw=1.5, markersize=5, alpha=1, label = "udT'")
axs[1].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[3, 12:22], axis=0), axis=0),     color='grey', marker='X', lw=1.5, markersize=5, alpha=1, label = "u'dT'")
...
axs[2].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[0, 23:30], axis=0), axis=0),     color='k', marker='s',    lw=1.5, markersize=5, alpha=1, label = "udT")
axs[2].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[1, 23:30], axis=0), axis=0),     color='r', marker='^',    lw=1.5, markersize=5, alpha=1, label = "u'dT")
axs[2].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[2, 23:30], axis=0), axis=0),     color='b', marker='X',    lw=1.5, markersize=5, alpha=1, label = "udT'")
axs[2].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_late[3, 23:30], axis=0), axis=0),     color='grey', marker='X', lw=1.5, markersize=5, alpha=1, label = "u'dT'")
...
plt.savefig("/home/sun/paint/phd/late_shf_collapse_p123.pdf")