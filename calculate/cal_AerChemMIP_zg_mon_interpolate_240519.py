'''
2024-6-6
This script is to deal with the CMIP6 zg, intepolating them to the same grids
...
data_path0    = '/home/sun/wd_disk/AerChemMIP/download/mon_zg_cat/'

interp_path0  = '/home/sun/data/AerChemMIP/mon_zg_samegrid/'
...
variable_list  =  ['zg',] # All of the above is wet_day
