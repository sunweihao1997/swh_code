'''
2024-8-25
This script is to calculate climatological ua under SSP370/SSP370lowNTCF simulation for March-April mean

Note:
MA / not include historical simulation
'''
import xarray as xr
import numpy as np
import os
...
path_src = '/home/sun/data/AerChemMIP/mon_{}_samegrid/'.format(varname)
...
#        
        ...
        dataset_allmodel.to_netcdf('/home/sun/data/AerChemMIP/process/multiple_model_climate_{}_month_MJJAS_all.nc'.format(varname))
