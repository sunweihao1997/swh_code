...
20250207 modified history: https://www.notion.so/Figure1_v2-Decompose-the-MTG-series-1a7d5b19b11d80f5b151f09ede937977?pvs=4
'''
...
def main():
    ...
    # Write time_series to ncfile
    ncfile  =  xr.Dataset(
    {
        "MTG_series": (["year", "day"], time_series_MTG_BOB),
    },
    coords={
    ...
    ncfile.attrs['description']  =  'Generated by script /home/sun/swh_code/calculate/cal_monsoon_onset_date_BOB_SCS_MTG_criterion_250227.py This ncfile save the MTG series over the BOB for each year.'
    ncfile.to_netcdf("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_daily_MTG_series_BOB_1940_2022.nc")
    
    print("Completely save the MTG file!")
    sys.exit()
