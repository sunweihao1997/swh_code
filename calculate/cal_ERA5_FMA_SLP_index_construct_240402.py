...
SLP_index = np.zeros((len(year_list)))
...
#    SLP_index[int(yy) - 1940] = np.nanmean(slp_land[1:4]) - np.nanmean(slp_sea[1:4])
    SLP_index[int(yy) - 1940] = np.nanmean(slp_land[1:4])
...
ncfile.attrs["description"]  =  "Created on 2024-4-2 at ubuntu(Beijing), this file generated from cal_ERA5_FMA_SLP_index_construct_240402.py and is the area-averaged SLP diff between land and sea"
ncfile.to_netcdf("/home/sun/data/process/ERA5/ERA5_SLP_Feb-Mar-Apr_land_slp_70-90_1940-2020.nc")