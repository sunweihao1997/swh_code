...
#    print(sample_multiple_year.shape)
    ...
    for yy in range(len(year_list)):
        ...
        sample_multiple_year[yy] = get_one_year_sample(file0_1yr, 'tasmin')
...
#                percentile3[yy, latt, lonn] = np.percentile(sample_multiple_year_reshape, 99)
    ...
    dates = pd.date_range(start='2000-06-01', end='2000-09-30', freq='D')
    ncfile  =  xr.Dataset(
            {
    ...
    ncfile.attrs['description'] = 'Created on 15-Apr-2024 by cal_AerChemMIP_heatwave_analysis_15day_sample_240414.py. The data in this file is the pencentile of the tasmin/tasmin based on 1980-2014 historical simulation'
...
if __name__ == '__main__':
    path0 = '/home/sun/data/process/model/aerchemmip-postprocess/tasmin/'
    path_out = '/home/sun/data/process/analysis/AerChem/heat_wave/sample_JJAS/tasmin/'
    ...
    # test
#    ftest  = xr.open_dataset('/home/sun/data/process/model/aerchemmip-postprocess/tasmin/EC-Earth3-AerChem_historical_r1i1p1f1.nc')
#
#    ftest2 = ftest.sel(time=ftest.time.dt.year.isin([2000]))
#
#    get_one_year_sample(ftest2, 'tasmin')
#    print(file_lists[1])
