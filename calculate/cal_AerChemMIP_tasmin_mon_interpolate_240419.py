...
data_path0    = '/Volumes/Untitled/AerChemMIP/tasmin_mon_postprocess/'

interp_path0  = '/Volumes/Untitled/AerChemMIP/tasmin_mon_postprocess_samegrid/'
...
variable_list  =  ['tasmin',] # All of the above is wet_day
