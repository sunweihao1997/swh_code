...
data_path0    = '/Volumes/Untitled/AerChemMIP/process/post-process/clt/'

interp_path0  = '/Volumes/Untitled/AerChemMIP/process/post-process/clt-same-grid/'
...
variable_list  =  ['clt',] # All of the above is wet_day
