...
data_path = '/Volumes/Untitled/AerChemMIP/tasmax/'
...
end_path  = '/Volumes/Untitled/AerChemMIP/process/post-process/tasmax/'
...
def cdo_inputfiles(datalists, new_name):
    cdo.cat(input = [(data_path + x) for x in datalists],output = end_path + new_name, options = '-b F32')
