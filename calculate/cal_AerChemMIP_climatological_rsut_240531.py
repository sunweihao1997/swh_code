...
#models_label = ['UKESM1-0-LL', 'GFDL-ESM4', 'MRI-ESM2','MPI-ESM-1-2-HAM', 'MIROC6',]

path_src = '/data/AerChemMIP/process/post-process/rsdt_samegrid/'
...
## --------------------------------------------------------------------------------------------------------------------        
            if len(group_ssp) == 3:
                print(group_ntcf[2][varname].data.shape)
...
#
            ...
            print('=============================================================')
#        
        dataset_allmodel.attrs['description'] = 'Created on 2024-5-31. This file includes the counts of the od550aer for single model, covering historical, SSP370 and SSP270lowNTCF experiments. All the variables is climatological, which is 1980-2014 for hist and 2031-2050 for SSP370.'
        dataset_allmodel.to_netcdf('/data/AerChemMIP/process/multiple_model_climate_rsdt_month_MJJAS.nc')
