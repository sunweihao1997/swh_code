...
out_path  = '/home/sun/data/process/model/aerchemmip-postprocess/day_prect_8_20/' # Path saves the filtered data
...
for ff in file_list:
    ...
    for i in range(len(lat)):
        for j in range(len(lon)):
            filter_pr[:, i, j] = band_pass_calculation(f1['pr'].data[:, i, j], fs=1, low_frq=20, high_frq=8, order=5,)
    ...
    ncfile.attrs['description'] = 'Created on 2024-4-28. This file save the 8-20 band-pass precipitation, generated by cal_AerChemMIP_band_pass_prect_240428.py.'
