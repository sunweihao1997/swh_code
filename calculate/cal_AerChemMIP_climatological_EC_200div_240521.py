...
models_label = ['UKESM1-0-LL']

path_src = '/home/sun/data/AerChemMIP/process/200_div_ncl/'
...
#        
        ...
        dataset_allmodel.to_netcdf('/home/sun/data/AerChemMIP/process/single_model_climate_div200_month_MJJAS.nc')
