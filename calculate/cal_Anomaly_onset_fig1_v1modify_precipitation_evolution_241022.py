...
# data about OLR
olr_bandpass_file1= xr.open_dataset("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_tp_bandpass_filter_12_30_new.nc").sel(lat=slice(15, 10), lon=slice(80, 90))    # best: lon=slice(80, 90)
olr_bandpass_file2= xr.open_dataset("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_tp_bandpass_filter_30_80_new.nc").sel(lat=slice(15, 10), lon=slice(80, 90))    # best: lon=slice(80, 87)
...
def plot_bandpass_olr(filter_avg, filter_std, time, day_notation):
    ...
    plt.savefig("/home/sun/paint/phd/phd_C5_fig1c_vtest_filtered_tp_timeseries_late.pdf")
...
if __name__ == '__main__':
    ...
    olr_bandpass_file_late1  = olr_bandpass_file1.sel(time=olr_bandpass_file1.time.dt.year.isin(late_years))
    olr_bandpass_file_late2  = olr_bandpass_file2.sel(time=olr_bandpass_file2.time.dt.year.isin(late_years))

    olr_late1, olr_late1_all                = cal_time_evolution_OLR_2edition(olr_bandpass_file_late1, "tp_filter")
    olr_late2, olr_late2_all                = cal_time_evolution_OLR_2edition(olr_bandpass_file_late2, "tp_filter")
    #olr_late[130:150] *= 1.5
    olr_origin,olr_origin_all              = cal_time_evolution_OLR_2edition(olr_bandpass_file1, "tp_filter")
...
#    # Send to plot function
    ...
    plot_bandpass_olr([olr_late1, olr_late2, olr_origin], [olr_late1_all, olr_late2_all, olr_origin_all], time_axis, [onset_day_avg_e, 137])
