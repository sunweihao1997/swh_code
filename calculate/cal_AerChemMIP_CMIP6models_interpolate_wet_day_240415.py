...
data_path0    = '/home/sun/data/process/analysis/AerChem/'

interp_path0  = '/home/sun/data/process/analysis/AerChem/wet_day_intepolation/'
...
#            print(fff)
            if fff[0] == '.':
                ...
                if 'historical' in fff:
                    ff  = ff0.sel(time=slice(1950, 2015))
                else:
                    ff  = ff0.sel(time=slice(2014, 2050))
