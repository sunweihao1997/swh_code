...
nino34     = xr.open_dataset('/home/sun/data/process/HadISST/HadISST_SST_IOB_month_1940_2020.nc')
...
def cal_period_correlationship(month, period, onset_f, nino34_f):
    ...
    corre0      = stats.pearsonr(signal.detrend(onset_date0['onset_day'].data) - np.average(signal.detrend(onset_date0['onset_day'].data)), signal.detrend(np.average(nino340['month_iob'].data[:, 1:4], axis=1)))
