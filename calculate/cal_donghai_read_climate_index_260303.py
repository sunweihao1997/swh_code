...
df = pd.read_csv(
    '/home/sun/data/download_data/climate_index_national_climate_center/M_Atmosphere_index_260303.txt',
    sep=r'\s+',
    index_col=0
)
...
result.to_csv(
    '/home/sun/wd_14/data/data/download_data/climate_index_national_climate_center/atmosphere_index_3mon.csv',
    encoding='utf-8-sig',
    index=True,
    index_label='date'
)