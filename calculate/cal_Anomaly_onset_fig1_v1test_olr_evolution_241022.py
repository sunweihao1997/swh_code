...
# data about OLR
olr_bandpass_file = xr.open_dataset("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_OLR_bandpass_filter_20_70_remove_seasonal.nc").sel(lat=slice(15, 10), lon=slice(85, 100))    # best: lon=slice(80, 90)
olr_bandpass_file2= xr.open_dataset("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_OLR_bandpass_filter_20_70_remove_seasonal.nc").sel(lat=slice(15, 10), lon=slice(82, 96))    # best: lon=slice(80, 87)
...
def plot_bandpass_olr(filter_avg, filter_std, time, day_notation):
    ...
    plt.savefig("/home/sun/paint/phd/phd_C5_fig1test_v0_filtered_olr_timeseries_new_2070.pdf")
