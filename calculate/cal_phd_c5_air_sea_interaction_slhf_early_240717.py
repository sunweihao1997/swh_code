...
# ======== File Information ==========
file0      = xr.open_dataset("/home/sun/data/climate_data/air_sea_interaction/climate_abnormal_u2m_v2m_t2m_ts_q2m.nc").sel(lat=slice(0, 6), lon=slice(55, 90))
file1      = xr.open_dataset("/home/sun/data/climate_data/air_sea_interaction/climate_abnormal_qs.nc").sel(lat=slice(0, 6), lon=slice(55, 90))
...
axs[0].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[0, 5:12], axis=0), axis=0),     color='k', marker='s',    lw=1.5, markersize=5, alpha=1, label = "udq")
axs[0].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[1, 5:12], axis=0), axis=0),     color='r', marker='^',    lw=1.5, markersize=5, alpha=1, label = "u'dq")
axs[0].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[2, 5:12], axis=0), axis=0),     color='b', marker='X',    lw=1.5, markersize=5, alpha=1, label = "udq'")
axs[0].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[3, 5:12], axis=0), axis=0),     color='grey', marker='X', lw=1.5, markersize=5, alpha=1, label = "u'dq'")
...
axs[1].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[0, 14:23], axis=0), axis=0),     color='k', marker='s',    lw=1.5, markersize=5, alpha=1, label = "udq")
axs[1].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[1, 14:23], axis=0), axis=0),     color='r', marker='^',    lw=1.5, markersize=5, alpha=1, label = "u'dq")
axs[1].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[2, 14:23], axis=0), axis=0),     color='b', marker='X',    lw=1.5, markersize=5, alpha=1, label = "udq'")
axs[1].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[3, 14:23], axis=0), axis=0),     color='grey', marker='X', lw=1.5, markersize=5, alpha=1, label = "u'dq'")
...
axs[2].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[0, 22:30], axis=0), axis=0),     color='k', marker='s',    lw=1.5, markersize=5, alpha=1, label = "udq")
axs[2].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[1, 22:30], axis=0), axis=0),     color='r', marker='^',    lw=1.5, markersize=5, alpha=1, label = "u'dq")
axs[2].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[2, 22:30], axis=0), axis=0),     color='b', marker='X',    lw=1.5, markersize=5, alpha=1, label = "udq'")
axs[2].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[3, 22:30], axis=0), axis=0),     color='grey', marker='X', lw=1.5, markersize=5, alpha=1, label = "u'dq'")
...
plt.savefig("/home/sun/paint/phd/slhf_e_p123.pdf")