...
mask_ocean = mask_file.sel(longitude=sea_lon, latitude=sea_lat)
...
def cal_LSTC_index(ffff):
    ...
    for tt in range(73):
        f_ocean['msl'].data[tt, ][mask_ocean['lsm'].data[0] > 0.2] = np.nan
...
ncfile['LSTC'].attrs['description'] = 'This is thermal difference between Indian continent(70-90, 5-15) and surround ocean(70-90, -20--30). The variable is SLP. time period is 1940 to 2022'
ncfile.attrs['description']  =  'Pentad difference between land and sea from 1940 to 2022 year'
ncfile.to_netcdf("/home/sun/data/onset_day_data/ERA5_pentad_LSTC_new_southern_ocean_indian_1940_2022.nc")