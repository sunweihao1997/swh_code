...
def judge_monsoon_onset(pr_series, start=150, threshold=5, thresholdday=10):
    '''
...
#            continue
        ...
        elif (np.average(pr_series[start + i + 5 : start + i + 5 +5]) - np.average(pr_series[0:30]) > threshold):
            continue 
...
ncfile.to_netcdf('/home/sun/data/process/analysis/AerChem/' + 'method_positive_modelmean_withdraw_day_threshold4.nc')
