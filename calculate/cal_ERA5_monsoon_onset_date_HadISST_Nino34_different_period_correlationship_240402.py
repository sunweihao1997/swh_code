...
nino34     = xr.open_dataset('/home/sun/data/process/HadISST/HadISST_SST_Nino34_month_1940_2020.nc')
...
def cal_period_correlationship(month, period, onset_f, nino34_f):
    ...
    corre0      = stats.pearsonr(signal.detrend(onset_date0['onset_day'].data) - np.average(signal.detrend(onset_date0['onset_day'].data)), signal.detrend(np.average(nino340['month_nino34'].data[:, 1:4], axis=1)))

    print(corre0)

cal_period_correlationship(3, period2, onset_date, nino34)
