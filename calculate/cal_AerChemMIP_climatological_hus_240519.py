'''
2024-5-22
This script is to calculate climatological va under SSP370/SSP370lowNTCF simulation
...
path_src = '/home/sun/data/AerChemMIP/mon_hus_samegrid/'
...
#
            ...
            print('=============================================================')
#        
        dataset_allmodel.attrs['description'] = 'Created on 2024-5-22. This file includes the counts of the hus for single model, covering SSP370 and SSP270lowNTCF experiments. All the variables is climatological, which is 1980-2014 for hist and 2031-2050 for SSP370.'
        dataset_allmodel.to_netcdf('/home/sun/data/AerChemMIP/process/multiple_model_climate_hus_month_MJJAS.nc')
