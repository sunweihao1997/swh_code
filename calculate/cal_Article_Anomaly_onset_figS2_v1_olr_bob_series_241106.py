...
# data about OLR
olr_bandpass_file = xr.open_dataset("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_OLR_bandpass_filter_20_70_remove_seasonal.nc").sel(lat=slice(15, 7), lon=slice(80, 100))    # best: lon=slice(80, 90)
olr_bandpass_file2= xr.open_dataset("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_OLR_bandpass_filter_20_70_remove_seasonal.nc").sel(lat=slice(15, 7), lon=slice(80, 95))    # best: lon=slice(80, 87)
...
def plot_bandpass_olr(filter_avg, filter_std, time, day_notation):
    ...
    plt.savefig("/home/sun/paint/monsoon_onset_composite_ERA5/Article_Anomaly_onset_v1_figs2b_BOB_olr_series_evolution.pdf")
...
if __name__ == '__main__':
    ...
    olr_early, olr_early_all               = cal_time_evolution_OLR_2edition(olr_bandpass_file_early, "olr")
    olr_late,  olr_late_all                = cal_time_evolution_OLR_2edition(olr_bandpass_file_late, "olr")
    #olr_late[130:150] *= 1.5
    olr_origin,olr_origin_all              = cal_time_evolution_OLR_2edition(olr_bandpass_file, "olr")
