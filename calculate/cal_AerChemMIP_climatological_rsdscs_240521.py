...
models_label = ['UKESM1-0-LL', 'GFDL-ESM4', 'MRI-ESM2','MPI-ESM-1-2-HAM', 'MIROC6', 'GISS-E2-1-G']

path_src = '/data/AerChemMIP/process/post-process/rsdscs_samegrid/'
...
#
            ...
            print('=============================================================')
#        
        dataset_allmodel.attrs['description'] = 'Created on 2024-4-24. This file includes the counts of the rsdscs for single model, covering historical, SSP370 and SSP270lowNTCF experiments. All the variables is climatological, which is 1980-2014 for hist and 2031-2050 for SSP370.'
        dataset_allmodel.to_netcdf('/data/AerChemMIP/process/multiple_model_climate_rsdscs_month_MJJAS.nc')
