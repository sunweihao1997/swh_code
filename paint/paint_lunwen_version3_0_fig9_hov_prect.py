...
def lon_avg_prect(time_slice=slice(100,201),lat_slice=slice(10,20),lon_slice=slice(65,130)):
    ...
    nomarin_prect   =  xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_maritime_atmosphere_new020.nc").sel(time=time_slice,lat = lat_slice,lon = lon_slice)
