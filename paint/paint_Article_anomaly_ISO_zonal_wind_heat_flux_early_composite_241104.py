...
def main():
    ...
    # UV wind
    uwind_c = xr.open_dataset(path1 + f_uwind[0]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))
    uwind_e = xr.open_dataset(path1 + f_uwind[1]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))
    uwind_l = xr.open_dataset(path1 + f_uwind[2]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))

    vwind_c = xr.open_dataset(path1 + f_vwind[0]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))
    vwind_e = xr.open_dataset(path1 + f_vwind[1]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))
    vwind_l = xr.open_dataset(path1 + f_vwind[2]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))

    #SSHF
    sshf_c = xr.open_dataset(path1 + f_sshf[0]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))
    sshf_e = xr.open_dataset(path1 + f_sshf[1]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))
    sshf_l = xr.open_dataset(path1 + f_sshf[2]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))

    #SLHF
    slhf_c = xr.open_dataset(path1 + f_slhf[0]).sel(time=slice(-30, 9), lat=slice(5, 0), lon=slice(55, 90))
...
#    print(lf_series)
    ...
    ax1.plot(np.linspace(55, 90, 36), sf_series0,     color='r', marker='s', lw=2.5, markersize=15, alpha=0.65, zorder=10)
    ax1.plot(np.linspace(55, 90, 36), sf_series1,     color='r', marker='^', lw=2.5, markersize=15, alpha=0.65, zorder=10)
    ax1.plot(np.linspace(55, 90, 36), sf_series2,     color='r', marker='X', lw=2.5, markersize=15, alpha=0.65, zorder=10)
    ax1.set_yticks([8, 10, 12, 14, 16, 18, 20])
 
    ax2 = ax1.twinx()
    ax2.plot(np.linspace(55, 90, 36), sl_series0,      color='b', marker='s', lw=2.5, markersize=15, alpha=0.65, zorder=11)
    ax2.plot(np.linspace(55, 90, 36), sl_series1,      color='b', marker='^', lw=2.5, markersize=15, alpha=0.65, zorder=11)
    ax2.plot(np.linspace(55, 90, 36), sl_series2,      color='b', marker='X', lw=2.5, markersize=15, alpha=0.65, zorder=11)
