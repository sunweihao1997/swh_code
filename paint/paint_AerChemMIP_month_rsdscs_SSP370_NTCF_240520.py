...
models_label = ['UKESM1-0-LL', 'GFDL-ESM4', 'MRI-ESM2','MPI-ESM-1-2-HAM', 'MIROC6', 'GISS-E2-1-G'] # GISS provide no daily data
...
if __name__ == '__main__':
    f0  =  xr.open_dataset('/data/AerChemMIP/process/multiple_model_climate_rsdscs_month_MJJAS.nc')
    ...
    plot_change_wet_day(np.nanmean(ssp0, axis=0), np.nanmean(ntcf0, axis=0), 'rsdscs (MJJAS)', 'rsdscs (MJJAS)', f0.lon.data, f0.lat.data, ttest, levels)