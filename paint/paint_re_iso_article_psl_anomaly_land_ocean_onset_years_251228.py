...
year_late = [1987, 1993,  2016, 2018, 2020]
...
if USE_REAL_DATA:
    ...
    try:
        ...
        print(f"成功加载数据，共 {len(psl_ocean)} 个月")
...
bars1 = ax1.bar(x - width, ocean_vals_early, width, label='Ocean (7090)', color=ocean_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars2 = ax1.bar(x, land_vals_early, width, label='Land (IOB)', color=land_color, alpha=0.8, edgecolor='black', linewidth=0.5)
...
bars3 = ax2.bar(x - width, ocean_vals_late, width, label='Ocean (7090)', color=ocean_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars4 = ax2.bar(x, land_vals_late, width, label='Land (IOB)', color=land_color, alpha=0.8, edgecolor='black', linewidth=0.5)
...
# 左图：海洋psl
ax3 = axes2[0]
bars5 = ax3.bar(x - width/2, ocean_vals_early, width, label='Early Onset', color=early_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars6 = ax3.bar(x + width/2, ocean_vals_late, width, label='Late Onset', color=late_color, alpha=0.8, edgecolor='black', linewidth=0.5)

ax3.axhline(y=0, color='black', linestyle='-', linewidth=1)
ax3.set_xlabel('Month', fontsize=12, fontweight='bold')
ax3.set_ylabel('PSL Anomaly (Pa)', fontsize=12, fontweight='bold')
ax3.set_title('Ocean (7090) PSL Anomaly\nEarly vs Late Onset', fontsize=14, fontweight='bold')
ax3.set_xticks(x)
...
# 中图：陆地psl
ax4 = axes2[1]
bars7 = ax4.bar(x - width/2, land_vals_early, width, label='Early Onset', color=early_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars8 = ax4.bar(x + width/2, land_vals_late, width, label='Late Onset', color=late_color, alpha=0.8, edgecolor='black', linewidth=0.5)

ax4.axhline(y=0, color='black', linestyle='-', linewidth=1)
ax4.set_xlabel('Month', fontsize=12, fontweight='bold')
ax4.set_ylabel('PSL Anomaly (Pa)', fontsize=12, fontweight='bold')
ax4.set_title('Land (IOB) PSL Anomaly\nEarly vs Late Onset', fontsize=14, fontweight='bold')
ax4.set_xticks(x)
...
# 子图1：早年海洋+陆地+差值
ax = axes3[0, 0]
bars_a = ax.bar(x - width, ocean_vals_early, width, label='Ocean', color=ocean_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars_b = ax.bar(x, land_vals_early, width, label='Land', color=land_color, alpha=0.8, edgecolor='black', linewidth=0.5)
...
ax.set_title('(a) Early Onset: Ocean, Land & Difference', fontsize=12, fontweight='bold')
ax.set_xticks(x)
...
# 子图2：晚年海洋+陆地+差值
ax = axes3[0, 1]
bars_d = ax.bar(x - width, ocean_vals_late, width, label='Ocean', color=ocean_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars_e = ax.bar(x, land_vals_late, width, label='Land', color=land_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars_f = ax.bar(x + width, diff_vals_late, width, label='Land-Ocean', color=diff_color, alpha=0.8, edgecolor='black', linewidth=0.5)
ax.axhline(y=0, color='black', linestyle='-', linewidth=1)
ax.set_ylabel('PSL Anomaly (Pa)', fontsize=11, fontweight='bold')
ax.set_title('(b) Late Onset: Ocean, Land & Difference', fontsize=12, fontweight='bold')
ax.set_xticks(x)
ax.set_xticklabels(month_names)
ax.legend(loc='best', fontsize=8)
ax.grid(axis='y', linestyle='--', alpha=0.5)
...
# 子图4：海洋 早年vs晚年
ax = axes3[1, 0]
bars_i = ax.bar(x - width_comp/2, ocean_vals_early, width_comp, label='Early', color=early_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars_j = ax.bar(x + width_comp/2, ocean_vals_late, width_comp, label='Late', color=late_color, alpha=0.8, edgecolor='black', linewidth=0.5)
ax.axhline(y=0, color='black', linestyle='-', linewidth=1)
ax.set_xlabel('Month', fontsize=11, fontweight='bold')
ax.set_ylabel('PSL Anomaly (Pa)', fontsize=11, fontweight='bold')
ax.set_title('(d) Ocean: Early vs Late Onset', fontsize=12, fontweight='bold')
ax.set_xticks(x)
ax.set_xticklabels(month_names)
ax.legend(loc='best', fontsize=9)
ax.grid(axis='y', linestyle='--', alpha=0.5)
...
# 子图5：陆地 早年vs晚年
ax = axes3[1, 1]
bars_k = ax.bar(x - width_comp/2, land_vals_early, width_comp, label='Early', color=early_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars_l = ax.bar(x + width_comp/2, land_vals_late, width_comp, label='Late', color=late_color, alpha=0.8, edgecolor='black', linewidth=0.5)
ax.axhline(y=0, color='black', linestyle='-', linewidth=1)
ax.set_xlabel('Month', fontsize=11, fontweight='bold')
ax.set_ylabel('PSL Anomaly (Pa)', fontsize=11, fontweight='bold')
ax.set_title('(e) Land: Early vs Late Onset', fontsize=12, fontweight='bold')
ax.set_xticks(x)
ax.set_xticklabels(month_names)
ax.legend(loc='best', fontsize=9)
ax.grid(axis='y', linestyle='--', alpha=0.5)
...
bars_m = ax.bar(x - width, ocean_diff, width, label='Ocean', color=ocean_color, alpha=0.8, edgecolor='black', linewidth=0.5)
bars_n = ax.bar(x, land_diff, width, label='Land', color=land_color, alpha=0.8, edgecolor='black', linewidth=0.5)
