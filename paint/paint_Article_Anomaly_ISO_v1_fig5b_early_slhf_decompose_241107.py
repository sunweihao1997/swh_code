...
axs[0].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[0, 0:10], axis=0), axis=0),  color='k',    marker='o', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udq")
axs[0].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[1, 0:10], axis=0), axis=0),  color='r',    marker='s', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dq")
axs[0].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[2, 0:10], axis=0), axis=0),  color='b',    marker='^', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udq'")
axs[0].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[3, 0:10], axis=0), axis=0),  color='grey', marker='D', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dq'")
...
axs[1].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[0, 14:23], axis=0), axis=0),      color='k',    marker='o', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udq")
axs[1].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[1, 14:23], axis=0), axis=0),      color='r',    marker='s', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dq")
axs[1].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[2, 14:23], axis=0), axis=0),      color='b',    marker='^', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udq'")
axs[1].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[3, 14:23], axis=0), axis=0),      color='grey', marker='D', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dq'")
...
axs[2].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[0, 22:30], axis=0), axis=0),     color='k',    marker='o', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udq")
axs[2].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[1, 22:30], axis=0), axis=0),     color='r',    marker='s', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dq")
axs[2].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[2, 22:30], axis=0), axis=0),     color='b',    marker='^', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udq'")
axs[2].plot(np.linspace(55, 90, 36), np.average(np.average(lhf_early[3, 22:30], axis=0), axis=0),     color='grey', marker='D', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dq'")
...
plt.savefig("/home/sun/paint/monsoon_onset_composite_ERA5/Article_Anomaly_ISO_v1_fig5_slhf_decompose.pdf")