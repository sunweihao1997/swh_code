...
#    newcmp.set_over('#145DA0')
    ...
    plt.savefig('/home/sun/paint/phd/phd_article_fig3_v2_climate_early_late_circulation_evolve_10mwind_pr_pentad_test.pdf')
# ============================================================================
...
# === Set time to paint ===
select_time = np.array([-27, -17, -10, -2])
number =  ["a","b","c","d","e"]
...
#    sshf_l = xr.open_dataset(path1 + f_sshf[2]).sel(time = select_time)
    ...
    # band-pass OLR
    select_timepr = np.array([-27, -17, -10, -2])
    olr_f0  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_precipitation_bandpass_3080_early_late_composite.nc").sel(time_composite = slice(select_timepr[0], select_timepr[0]+4))
    olr_f1  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_precipitation_bandpass_3080_early_late_composite.nc").sel(time_composite = slice(select_timepr[1], select_timepr[1]+4))
    olr_f2  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_precipitation_bandpass_3080_early_late_composite.nc").sel(time_composite = slice(select_timepr[2], select_timepr[2]+4))
    olr_f3  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_precipitation_bandpass_3080_early_late_composite.nc").sel(time_composite = slice(select_timepr[3], select_timepr[3]+4))
