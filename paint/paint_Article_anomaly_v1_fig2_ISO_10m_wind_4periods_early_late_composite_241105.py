...
#    newcmp.set_over('#145DA0')
    ...
    plt.savefig('/home/sun/paint/monsoon_onset_composite_ERA5/paint_article_anomaly_ISO_v1_fig2_composite_10mwind_pr_evolution.pdf')
# ============================================================================
...
# === Set time to paint ===
select_time = np.array([-17, -12, -7, -2])
number =  ["a","b","c","d","e"]
...
def main():
    ...
    # UV wind
    uwind_c0 = xr.open_dataset(path1 + f_uwind[0]).sel(time = slice(select_time[0], select_time[0]+5)); uwind_c1 = xr.open_dataset(path1 + f_uwind[0]).sel(time = slice(select_time[1], select_time[1]+5)) ; uwind_c2 = xr.open_dataset(path1 + f_uwind[0]).sel(time = slice(select_time[2], select_time[2]+5)) ; uwind_c3 = xr.open_dataset(path1 + f_uwind[0]).sel(time = slice(select_time[3], select_time[3]+5))
    uwind_e0 = xr.open_dataset(path1 + f_uwind[1]).sel(time = slice(select_time[0], select_time[0]+5)); uwind_e1 = xr.open_dataset(path1 + f_uwind[1]).sel(time = slice(select_time[1], select_time[1]+5)) ; uwind_e2 = xr.open_dataset(path1 + f_uwind[1]).sel(time = slice(select_time[2], select_time[2]+5)) ; uwind_e3 = xr.open_dataset(path1 + f_uwind[1]).sel(time = slice(select_time[3], select_time[3]+5))
    uwind_l0 = xr.open_dataset(path1 + f_uwind[2]).sel(time = slice(select_time[0], select_time[0]+5)); uwind_l1 = xr.open_dataset(path1 + f_uwind[2]).sel(time = slice(select_time[1], select_time[1]+5)) ; uwind_l2 = xr.open_dataset(path1 + f_uwind[2]).sel(time = slice(select_time[2], select_time[2]+5)) ; uwind_l3 = xr.open_dataset(path1 + f_uwind[2]).sel(time = slice(select_time[3], select_time[3]+5))
    vwind_c0 = xr.open_dataset(path1 + f_vwind[0]).sel(time = slice(select_time[0], select_time[0]+5)); vwind_c1 = xr.open_dataset(path1 + f_vwind[0]).sel(time = slice(select_time[1], select_time[1]+5)) ; vwind_c2 = xr.open_dataset(path1 + f_vwind[0]).sel(time = slice(select_time[2], select_time[2]+5)) ; vwind_c3 = xr.open_dataset(path1 + f_vwind[0]).sel(time = slice(select_time[3], select_time[3]+5))
    vwind_e0 = xr.open_dataset(path1 + f_vwind[1]).sel(time = slice(select_time[0], select_time[0]+5)); vwind_e1 = xr.open_dataset(path1 + f_vwind[1]).sel(time = slice(select_time[1], select_time[1]+5)) ; vwind_e2 = xr.open_dataset(path1 + f_vwind[1]).sel(time = slice(select_time[2], select_time[2]+5)) ; vwind_e3 = xr.open_dataset(path1 + f_vwind[1]).sel(time = slice(select_time[3], select_time[3]+5))
    vwind_l0 = xr.open_dataset(path1 + f_vwind[2]).sel(time = slice(select_time[0], select_time[0]+5)); vwind_l1 = xr.open_dataset(path1 + f_vwind[2]).sel(time = slice(select_time[1], select_time[1]+5)) ; vwind_l2 = xr.open_dataset(path1 + f_vwind[2]).sel(time = slice(select_time[2], select_time[2]+5)) ; vwind_l3 = xr.open_dataset(path1 + f_vwind[2]).sel(time = slice(select_time[3], select_time[3]+5))
...
#    sshf_l = xr.open_dataset(path1 + f_sshf[2]).sel(time = select_time)
    ...
    olr_f0  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_precipitation_bandpass_2070_early_late_composite.nc").sel(time_composite = slice(select_timepr[0], select_timepr[0]+5))
    olr_f1  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_precipitation_bandpass_2070_early_late_composite.nc").sel(time_composite = slice(select_timepr[1], select_timepr[1]+5))
    olr_f2  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_precipitation_bandpass_2070_early_late_composite.nc").sel(time_composite = slice(select_timepr[2], select_timepr[2]+5))
    olr_f3  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_precipitation_bandpass_2070_early_late_composite.nc").sel(time_composite = slice(select_timepr[3], select_timepr[3]+5))
