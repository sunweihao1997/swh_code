...
#    u_series1[u_series1<0] = 0
    ...
    sf_series0 = np.average(np.average(sshf_e['sshf'][5:15]/-86400*24, axis=0), axis=0)
    sf_series1 = np.average(np.average(sshf_e['sshf'][15:25]/-86400*24, axis=0), axis=0)
    sf_series2 = np.average(np.average(sshf_e['sshf'][25:30]/-86400*24, axis=0), axis=0)
#    sf_series0[17:30] -= 0.5

    sl_series0 = np.average(np.average(slhf_e['slhf'][5:15]/-86400*24, axis=0), axis=0)
    sl_series1 = np.average(np.average(slhf_e['slhf'][15:25]/-86400*24, axis=0), axis=0)
    sl_series2 = np.average(np.average(slhf_e['slhf'][25:30]/-86400*24, axis=0), axis=0)
...
#    ax3.plot(sl_series2,      color='b', marker='*', lw=2.3, markersize=15, alpha=0.5)
    ...
    plt.savefig('/home/sun/paint/phd/c5_fig5_early_sshf_slhf_windspeed_lon.pdf')
