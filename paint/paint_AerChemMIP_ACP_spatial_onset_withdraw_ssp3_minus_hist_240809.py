...
rainyseason = 1*(five_points_smoother((f0['withdraw_ssp3'].data - f1['onset_ssp3'].data) - (f0['withdraw_hist'].data - f1['onset_hist'].data)))
rainyseason[(f1['onset_ssp3'].data-f1['onset_hist'].data)==0] = np.nan
im = ax.pcolormesh(f0.lon.data, f0.lat.data, rainyseason, cmap=newcmp, vmin=-20, vmax=20)
...
ax.set_title('SSP370 - Hist', loc='right', fontsize=25)
...
plt.savefig('/home/sun/paint/AerMIP/Article_rainyseason_Bingwang_diff_threshold4_ssp370_minus_hist.pdf')
