...
# 绘制降水填色图
im  =  ax.contourf(f_ctl.lon.data,f_ctl.lat.data,-1*ts,np.linspace(-5,5,11),cmap='coolwarm',alpha=1,extend='both')
...
# 保存图片  
save_fig(path_out="/home/sun/paint/phd/",file_out="phd_c4_fig9_Apr_wind_precipitation_inch.pdf")
