...
#    newcmp.set_over('#145DA0')
    ...
    for col in range(4):
        ...
        im2  =  ax.contourf(lon_trmm, lat_trmm, precip[t][j], np.linspace(-20,20,11), cmap=newcmp, alpha=1, extend='both')
        ...
        ax.set_title(select_time[j], loc='right', fontsize=25)
    ...
    plt.savefig('/home/sun/paint/lunwen/anomoly_analysis/v0_fig1_v2_climate_early_late_circulation_evolve_10mwind_OLR_sshf_test.pdf')
# ============================================================================
...
def main():
    ...
    # band-pass OLR
    olr_f  = xr.open_dataset("/home/sun/data/composite/early_late_composite/ERA5_OLR_bandpass_early_late_composite.nc").sel(time=select_time)


    #trmm_combined  = [trmm['trmm_climate'].data, trmm['trmm_early'].data, trmm['trmm_late'].data]
    olr_combined   = [-1*olr_f['olr_early'].data, -1*olr_f['olr_late'].data]
