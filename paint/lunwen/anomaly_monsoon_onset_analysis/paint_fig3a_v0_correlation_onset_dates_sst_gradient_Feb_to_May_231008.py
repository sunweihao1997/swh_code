...
corr_list = [corr_file['corre_feb'], corr_file['corre_mar'], corr_file['corre_apr'], corr_file['corre_may'],]
...
def paint_12month_correlation(correlation, extent, lon, lat, title):
    ...
    for col in range(4):
        for row in range(1):
            ...
            im2 = ax.contourf(lons, lat, data, [-1, -0.30, 0, 0.30, 1], hatches=['.', None, None, '.'], colors="none", transform=ccrs.PlateCarree())
    ...
    save_fig(path_out="/home/sun/paint/index_correlation_with_onsetdate/",file_out="lunwen_fig3a_v0_correlation_onsetdates_sst_gradient.pdf")

def main():
    lonmin,lonmax,latmin,latmax  =  30,330,45,-45
    extent     =  [lonmin,lonmax,latmin,latmax]
    paint_12month_correlation(corr_list, extent, corr_file['lon'], corr_file['lat'], "SST gradient(99%)")
