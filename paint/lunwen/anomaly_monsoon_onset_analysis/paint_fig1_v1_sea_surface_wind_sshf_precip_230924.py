...
def paint_composite_wind_sensible_precip(lat_era5, lon_era5, lat_trmm, lon_trmm, u, v, sshf, precip, extent):
    ...
    for col in range(4):
        ...
        ax.set_title('Early year', loc='right', fontsize=25)
    ...
    for col in range(4):
        ...
        # Add title of day
        ax.set_title(fig_number3[j], loc='left', fontsize=25)
        ax.set_title('Late year', loc='right', fontsize=25)
    ...
    plt.savefig('/home/sun/paint/lunwen/anomoly_analysis/v0_fig1_v1_climate_early_late_circulation_evolve_10mwind_precipitation_sshf.pdf')
# ============================================================================
