...
if __name__ == '__main__':
    f0  =  xr.open_dataset('/data/AerChemMIP/process/multiple_model_climate_reffclwtop_month_MJJAS.nc')
    ...
    levels    =  [-4, -3, -2, -1, -0.05, 0.05, 1, 2, 3, 4,]
    plot_change_wet_day(np.nanmean(ssp0, axis=0)*1e7, np.nanmean(ntcf0, axis=0)*1e7, 'reffclwtop (MJJAS)', 'reffclwtop (MJJAS)', f0.lon.data, f0.lat.data, ttest, levels)