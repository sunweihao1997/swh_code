...
path_src = '/home/sun/CMIP6/CMIP6_CESM2/pr/ensemble_mean/'

file_src = 'CESM2_historical_PRECT_8_member_average.nc'
...
def cal_JJAS_mean(f0, mon_list, varname):
    ...
    ncfile  =  xr.Dataset(
        {
            "JJAS_PRECT": (["time", "lat", "lon"], JJAS_PRECT * 86400),
        },
        coords={
...
def plot_area_average_evolution(f0, varname, extent):
    ...
    ax.set_ylabel("Historical", fontsize=11)

    ax.set_title("CESM2", loc='left', fontsize=15)
    ax.set_title("76-87°E, 20-28°N", loc='right', fontsize=15)

    plt.savefig("/home/sun/paint/EUI_CESM2_PRECT_historical_evolution_area_average_Indian_key_region.pdf", dpi=700)
