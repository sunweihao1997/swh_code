...
# =========== File Information ==============
f_ctl = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_control_climate_atmosphere.nc")
f_inc = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_inch_climate_atmosphere.nc")
f_ind = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_indian_climate_atmosphere3.nc")
f_mar = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_maritime_climate_atmosphere.nc")
...
#                f_mar['TS'].data[tt, latt, lonn] = np.nan
#
## ----------- save to the ncfile ------------------
#ncfile  =  xr.Dataset(
#{
...
#    "sst_mar": (["time", "lat", "lon"], f_mar['TS'].data),
#},
#coords={
...
#ncfile.to_netcdf("/home/sun/data/model_data/climate/b1850_exp/b1850_control_inch_indian_maritime_climate_sst.nc")
fsst = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_control_inch_indian_maritime_climate_sst.nc")
fsst_northbob = fsst.sel(lat=slice(10, 15), lon=slice(85, 100)) ; fsst_southbob = fsst.sel(lat=slice(0, 5), lon=slice(85, 100))

ctl_north_bob = np.nanmean(np.nanmean(fsst_northbob['sst_ctl'].data - 273.15, axis=1), axis=1)
ctl_south_bob = np.nanmean(np.nanmean(fsst_southbob['sst_ctl'].data - 273.15, axis=1), axis=1)
inc_north_bob = np.nanmean(np.nanmean(fsst_northbob['sst_mar'].data - 273.15, axis=1), axis=1)
inc_south_bob = np.nanmean(np.nanmean(fsst_southbob['sst_mar'].data - 273.15, axis=1), axis=1)

# ========= Plot the time series ==========
fig, ax = plt.subplots(figsize=(8.5, 4))
ax.plot(ctl_north_bob[90:150], color='red', lw=2,  label='North BOB')
ax.plot(ctl_south_bob[90:150], color='blue', lw=2, label='South BOB')
ax.plot(inc_north_bob[90:150], '--', color='red', lw=2)
ax.plot(inc_south_bob[90:150], '--', color='blue', lw=2)
...
ax.set_ylim((27.5, 32.5))

ax.grid()

fig.savefig("/home/sun/paint/phd/north_south_BOB_sst_ctrl_minus_maritime.pdf")
