...
# 范围设置
lonmin,lonmax,latmin,latmax  =  70,150,-10,30
...
level0 = np.array([ -50, -40, -30, -20, -10, -5, 5, 10, 20, 30, 40, 50,])
im  =  ax.contourf(f_ctl.lon.data,f_ctl.lat.data,psl,level0,cmap=new_cmap,alpha=1,extend='both')
...
a.set_ticks(np.array([-50, -30, -10, -5, 5, 10, 30, 50]))
