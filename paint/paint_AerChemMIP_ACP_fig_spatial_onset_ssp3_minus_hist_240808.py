...
f0  =  xr.open_dataset('/home/sun/data/process/analysis/AerChem/modelmean_onset_day_threshold3.5.nc')
...
diff_onset = f0['onset_ssp3'].data - f0['onset_hist'].data
#print(diff_onset[:, 50])
...
plt.savefig('/home/sun/paint/AerMIP/Article_onset_Bingwang_diff_threshold4_ssp370_minus_hist.pdf')
