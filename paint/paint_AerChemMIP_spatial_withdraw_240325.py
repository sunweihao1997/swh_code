...
im = ax.pcolormesh(f0.lon.data, f0.lat.data, 1.1*(f0['withdraw_ssp3'].data - f0['withdraw_ntcf'].data), cmap=newcmp, vmin=-15, vmax=15)
...
plt.savefig('/home/sun/paint/AerMIP/modelmean_withdraw_Bingwang_diff_threshold4.png')
