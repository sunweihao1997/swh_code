...
diff_withdraw = f0['withdraw_ntcf'].data - f0['withdraw_hist'].data
#print(diff_onset[:, 50])
...
plt.savefig('/home/sun/paint/AerMIP/Article_withdraw_Bingwang_diff_threshold4_ssp370ntcf_minus_hist.pdf')
