...
diff_withdraw = f0['withdraw_ssp3'].data - f0['withdraw_hist'].data
#print(diff_onset[:, 50])
diff_withdraw[diff_withdraw == 0.] = np.nan
im = ax.pcolormesh(f0.lon.data, f0.lat.data, (diff_withdraw), cmap=newcmp, vmin=-15, vmax=15)
...
plt.savefig('/home/sun/paint/AerMIP/Article_withdraw_Bingwang_diff_threshold4_ssp370_minus_hist.pdf')
