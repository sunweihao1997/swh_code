...
#    from module_sun import set_cartopy_tick
    u[(u**2+v**2)<0.001] = np.nan

    # -------   cartopy extent  -----
    lonmin,lonmax,latmin,latmax  =  40,170,-30,40
...
#    cb.set_ticklabels(ct_level)
    ...
    plt.savefig("/home/sun/paint/AerChemMIP/AerChemMIP_modelgroup_spatial_200wind_MA_ntcf_linear_trend_{}.pdf".format(figname))
...
if __name__ == '__main__':
    ...
    # -------- u --------------
    f0  =  xr.open_dataset('/home/sun/data/AerChemMIP/process/multiple_model_climate_ua_month_MA.nc').sel(plev=20000)
...
#    sys.exit(u.shape)
    ...
    # -------- v ---------------
    f0  =  xr.open_dataset('/home/sun/data/AerChemMIP/process/multiple_model_climate_va_month_MA.nc').sel(plev=20000)
...
#    ttest     =  cal_student_ttest(ssp0, ntcf0)
    ...
    levels    =  np.linspace(-15, 15, 11, dtype=int)
    plot_change_wind_psl(u*10, v*10, psl*10, '200 hPa', '200 hPa', f0.lon.data, f0.lat.data, ttest, levels)