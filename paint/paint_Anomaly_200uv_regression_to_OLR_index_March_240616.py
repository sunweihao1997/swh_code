...
def paint_picture(lon, lat, u, v, psl, corre):
    ...
    # 保存图片
    save_fig(path_out="/home/sun/paint/phd/",file_out="phd_thesis_C5_fig7_March_200_uv_500w_to_OLR_index.pdf")
...
def main():
    ...
    paint_picture(lon=f1.lon,lat=f1.lat,u=f1['rc_u'].data*1, v=f1['rc_v'].data*1, psl=f1['rc_w'].data*1000, corre=f1['prob_w_olr'].data)
