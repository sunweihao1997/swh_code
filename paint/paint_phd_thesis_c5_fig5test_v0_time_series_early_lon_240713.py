...
def main():
    ...
    sf_series1 = np.average(np.average(sshf_e['sshf'][15:20]/-86400*24, axis=0), axis=0)
    sf_series2 = np.average(np.average(sshf_e['sshf'][20:25]/-86400*24, axis=0), axis=0)
    sf_series3 = np.average(np.average(sshf_e['sshf'][25:30]/-86400*24, axis=0), axis=0)
