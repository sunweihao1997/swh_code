...
def paint_picture(lon, lat, u, v, psl, corre, correu):
    ...
    # 保存图片
    save_fig(path_out="/home/sun/paint/phd/",file_out="phd_c5_v1_fig7test_apr_regression_uv_psl_ttest.pdf")

def main():
    f1 = xr.open_dataset('/home/sun/data/monsoon_onset_anomaly_analysis/ERA5_data_monsoon_onset/regression/ERA5_regression_10uv_psl_to_LSTC_ttest_apr.nc')
    #print(f1)
