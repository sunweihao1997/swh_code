'''
2024-2-6
This script is to plot the correlation between the May precipitation and Nino34 index, based on ERA5
'''
import xarray as xr
import numpy as np
import sys
...
f0        = xr.open_dataset(data_path + 'ERA5_correlation_May_precipitation_Nino34.nc')
...
ax.set_title('ERA5', loc='right', fontsize=15)
...
plt.savefig('/home/sun/paint/ERA5_May_precip_Nino34.pdf', dpi=600)