...
f0           = xr.open_dataset('/home/sun/data/process/analysis/AerChem/NCEP_AerChemMIP_monsoon_percentile_onsetdate_Zeng.nc')
...
def paint_onset_day_single_model():
    ...
    for row in range(model_number):
        ...
        im  =  ax_hist.pcolormesh(f0.lon.data, f0.lat.data, 1.1*(f0['onsetdate_'+models_label[row]+'_hist'].data - f0['onsetdate_'+models_label[row]+'_ssp'].data), cmap=newcmp, vmin=vmin, vmax=vmax)
        ...
        im  =  ax_hist.pcolormesh(f0.lon.data, f0.lat.data, 1.1*(f0['onsetdate_'+models_label[row]+'_hist'].data - f0['onsetdate_'+models_label[row]+'_sspntcf'].data), cmap=newcmp, vmin=vmin, vmax=vmax)
        ...
        im  =  ax_hist.pcolormesh(f0.lon.data, f0.lat.data, 1.1*(f0['onsetdate_'+models_label[row]+'_ssp'].data - f0['onsetdate_'+models_label[row]+'_sspntcf'].data), cmap=newcmp, vmin=vmin, vmax=vmax)
    ...
    plt.savefig("/home/sun/paint/AerMIP/spatial_new_criterion_onset_dates_multiple_model.png")
