...
im  =  ax.contourf(f0.longitude.data, f0.latitude.data, gaussian_filter(100 * ((pr_late - pr_climate) /pr_climate), sigma=1), np.linspace(-100, 100, 11), cmap='coolwarm',alpha=1,extend='both')
...
# 绘制矢量图
q  =  ax.quiver(f0.longitude.data, f0.latitude.data, u_late - u_climate, v_late - v_climate, 
...
plt.savefig("/home/sun/paint/CD/FigureS_supplementary_late_composite_uv850pr.pdf")