...
rainyseason = 1*(five_points_smoother((f0['withdraw_ntcf'].data - f1['onset_ntcf'].data) - (f0['withdraw_hist'].data - f1['onset_hist'].data)))
...
plt.savefig('/home/sun/paint/AerMIP/Article_rainyseason_Bingwang_diff_threshold4_ssp370ntcf_minus_hist.pdf')
