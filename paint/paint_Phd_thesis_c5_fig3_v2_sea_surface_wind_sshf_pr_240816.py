...
#    newcmp.set_over('#145DA0')
    ...
    plt.savefig('/home/sun/paint/phd/phd_C5_fig3_v2_climate_early_late_circulation_evolve_10mwind_pr_pentad_test.pdf')
# ============================================================================
...
# === Set time to paint ===
select_time = np.array([-24, -17, -10, -2])
number =  ["a","b","c","d","e"]
...
#    sshf_l = xr.open_dataset(path1 + f_sshf[2]).sel(time = select_time)
    ...
    # band-pass OLR
    select_timepr = np.array([-22, -17, -12, -2])
