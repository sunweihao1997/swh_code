...
def paint_picture(lon,lat,avg_t2m,avg_u,avg_v):
    ...
    # 绘制气温等值线
    im  =  ax.contourf(lon,lat,avg_t2m-273.15,np.linspace(0,12,13),cmap=cmp,alpha=1,extend='both')

    # 绘制海岸线
    ax.coastlines(resolution='110m',lw=1)

    ax.set_title("700 hPa", loc='right', fontsize=22.5)
    ax.set_title("(b)", loc='left', fontsize=22.5)
    ...
    # 保存图片
    save_fig(path_out="/home/sun/paint/phd/",file_out="phd_c3_fig1b_700t_700wind.pdf")
...
def main():
    ...
    f1   =  xr.open_dataset("/home/sun/data/merra2_climate_vars_multi/monthly/merra2_climate_monthly_vars.nc").sel(lev=700)
