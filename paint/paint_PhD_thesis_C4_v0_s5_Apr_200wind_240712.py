...
# =========== File Information ==============
f_ctl = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_control_climate_atmosphere.nc").sel(lev=150)
f_ind = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_maritime_atmosphere_new020.nc").sel(lev=150)
...
vy = np.gradient(v,location,axis=0)
ux = copy.deepcopy(vy)
for i in range(1,191):
    ux[i,:] = np.gradient(u[i,:],disx[i],axis=0)
...
im  =  ax.contourf(f_ctl.lon.data,f_ctl.lat.data,div,np.linspace(-5, 5, 11),cmap='coolwarm',alpha=1,extend='both')
...
# 保存图片  
save_fig(path_out="/home/sun/paint/phd/",file_out="phd_c4_figs4_apr_pr_diff_150wind_May.pdf")
