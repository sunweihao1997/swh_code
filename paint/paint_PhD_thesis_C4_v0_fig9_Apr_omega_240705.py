...
# =========== File Information ==============
lev0 = 850
f_ctl = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_control_climate_atmosphere.nc").sel(lev=lev0)
f_ind = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_inch_climate_atmosphere.nc").sel(lev=lev0)
...
ts    = np.average(f_ctl['OMEGA'].data[start0:end0], axis=0)    - np.average(f_ind['OMEGA'].data[start0:end0], axis=0)
...
# 绘制降水填色图
im  =  ax.contourf(f_ctl.lon.data,f_ctl.lat.data,-100*ts,np.linspace(-5,5,11),cmap='coolwarm',alpha=1,extend='both')
...
# 保存图片  
save_fig(path_out="/home/sun/paint/phd/",file_out="phd_c4_fig9_Apr_OMEGA.pdf")
