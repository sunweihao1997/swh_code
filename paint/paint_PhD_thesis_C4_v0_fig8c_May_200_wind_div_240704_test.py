...
# =========== File Information ==============
f_ctl = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_control_climate_atmosphere.nc").sel(lev=slice(500, 200))
f_ind = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_indian_climate_atmosphere3.nc").sel(lev=slice(500, 200))
...
u     = np.average(f_ctl['U'].data[120:150, -1, ], axis=0) - np.average(f_ind['U'].data[120:150, -1, ], axis=0)
v     = np.average(f_ctl['V'].data[120:150, -1, ], axis=0) - np.average(f_ind['V'].data[120:150, -1, ], axis=0)
t     = np.average(np.average(f_ctl['T'].data[120:150], axis=0), axis=0) - np.average(np.average(f_ind['T'].data[120:150], axis=0), axis=0)
...
im  =  ax.contourf(f_ctl.lon.data,f_ctl.lat.data,t,level0,cmap='coolwarm',alpha=1,extend='both')
...
# 保存图片
save_fig(path_out="/home/sun/paint/phd/",file_out="phd_c4_fig8c_May_200_uv_t.pdf")
