'''
2025-6-27
This script is to plot the scorrelationship between BOBSM onset date and monthly precipitation
'''
import sys
...
im  =  axs[0, 0].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['scorrelation_may'].data, np.linspace(-1, 1, 11),cmap='coolwarm',alpha=1,extend='both')

im2 =  axs[0, 0].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['p_may'].data, [0, 0.125], colors='none', hatches=['..'])
...
im  =  axs[0, 1].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['scorrelation_jun'].data, np.linspace(-1, 1, 11),cmap='coolwarm',alpha=1,extend='both')

im2 =  axs[0, 1].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['p_jun'].data, [0, 0.125], colors='none', hatches=['..'])
...
im  =  axs[1, 0].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['scorrelation_jul'].data, np.linspace(-1, 1, 11),cmap='coolwarm',alpha=1,extend='both')

im2 =  axs[1, 0].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['p_jul'].data, [0, 0.125], colors='none', hatches=['..'])
...
im  =  axs[1, 1].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['scorrelation_aug'].data, np.linspace(-1, 1, 11),cmap='coolwarm',alpha=1,extend='both')

im2 =  axs[1, 1].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['p_aug'].data, [0, 0.125], colors='none', hatches=['..'])
...
plt.savefig("/home/sun/paint/CD/FigureS_supplementary_scorrelation_BOBSM_precipitation_5678_pearson_cb.pdf")