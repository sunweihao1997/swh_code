...
im  =  axs[0, 0].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['correlation_may'].data, np.linspace(-1, 1, 11),cmap='coolwarm',alpha=1,extend='both')
...
im  =  axs[0, 1].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['correlation_jun'].data, np.linspace(-1, 1, 11),cmap='coolwarm',alpha=1,extend='both')
...
im  =  axs[1, 0].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['correlation_jul'].data, np.linspace(-1, 1, 11),cmap='coolwarm',alpha=1,extend='both')
...
im  =  axs[1, 1].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['correlation_aug'].data, np.linspace(-1, 1, 11),cmap='coolwarm',alpha=1,extend='both')

im2 =  axs[1, 1].contourf(corr_file['longitude'].data, corr_file['latitude'].data, corr_file['p_aug'].data, [0, 0.125], colors='none', hatches=['..'])

plt.savefig("/home/sun/paint/CD/FigureS_supplementary_correlation_BOBSM_precipitation_5678_pearson.pdf")