...
This script is generated from paint_AerChemMIP_wet_day_diff_SSP370_NTCF_240416.py to compare the pr10
'''
import xarray as xr
import numpy as np
...
def plot_change_wet_day(hist, ssp, sspntcf, left_string, figname, lon, lat, ct_level=np.linspace(-10., 10., 21)):
    ...
    for col in range(3):
        ...
        ax.set_title(right_title[col], loc='right', fontsize=16.5)
    ...
    plt.savefig("/home/sun/paint/AerMIP/AerChemMIP_modelgroup_spatial_JJAS_hist_ssp370_ntcf_{}_test.png".format(figname))
