...
olr_f     = xr.open_dataset("/home/sun/wd_14/data_beijing/composite/early_late_composite/ERA5_precipitation_bandpass_2070_early_late_composite.nc").sel(lon=lon_slice)
