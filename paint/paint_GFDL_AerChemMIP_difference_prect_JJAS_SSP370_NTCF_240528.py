...
for yy in year_list:
    ...
    pr_ssp_JJAS[k]  = np.average(JJAS_f_year['allmodel_pr_ssp'].data[2], axis=0) 
    pr_ntcf_JJAS[k] = np.average(JJAS_f_year['allmodel_pr_ntcf'].data[2], axis=0)
...
#        ax.add_patch(rect_ea)
    ...
    plt.savefig("/data/paint/modelgroup_spatial_MJJAS_SSP370-SSP370NTCF_precip_GFDL.png")
