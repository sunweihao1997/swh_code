...
f_ind = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_maritime_atmosphere_new.nc").sel(lev=850)
...
#pr    = np.average(f_ctl['PRECT'].data[start0:end0], axis=0)
...
# 绘制降水填色图
im  =  ax.contourf(f_ctl.lon.data,f_ctl.lat.data,pr*86400000,np.linspace(-8, 8, 11),cmap='coolwarm',alpha=1,extend='both')
...
# 保存图片  
save_fig(path_out="/home/sun/paint/phd/",file_out="phd_c4_figs4_may_pr_ctrl.pdf")
