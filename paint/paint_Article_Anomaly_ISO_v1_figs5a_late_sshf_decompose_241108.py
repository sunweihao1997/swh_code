...
axs[0].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[0, 0:10,], axis=0), axis=0),     color='k',    marker='o', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udT")
axs[0].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[1, 0:10,], axis=0), axis=0),     color='r',    marker='s', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dT")
axs[0].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[2, 0:10,], axis=0), axis=0),     color='b',    marker='^', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udT'")
axs[0].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[3, 0:10,], axis=0), axis=0),     color='grey', marker='D', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dT'")
...
axs[1].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[0, 10:20], axis=0), axis=0),     color='k',    marker='o', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udT")
axs[1].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[1, 10:20], axis=0), axis=0),     color='r',    marker='s', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dT")
axs[1].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[2, 10:20], axis=0), axis=0),     color='b',    marker='^', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udT'")
axs[1].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[3, 10:20], axis=0), axis=0),     color='grey', marker='D', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dT'")
...
axs[2].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[0, 20:30], axis=0), axis=0),     color='k',    marker='o', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udT")
axs[2].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[1, 20:30], axis=0), axis=0),     color='r',    marker='s', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dT")
axs[2].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[2, 20:30], axis=0), axis=0),     color='b',    marker='^', markevery=2, lw=2, markersize=7.5, alpha=1, label = "udT'")
axs[2].plot(np.linspace(55, 90, 36), -1 * np.average(np.average(shf_climate[3, 20:30], axis=0), axis=0),     color='grey', marker='D', markevery=2, lw=2, markersize=7.5, alpha=1, label = "u'dT'")
...
plt.savefig("/home/sun/paint/monsoon_onset_composite_ERA5/Article_Anomaly_ISO_v1_figs5a_sshf_decompose_normal.pdf")