...
#    print(np.nanmean(fxg))
    ...
    plot_change_wet_day(np.nanmean(ssp0, axis=0), np.nanmean(ntcf0, axis=0), f1.Fx.data * 100, f2.Fy.data * 100, '300hPa zg WAF (MJJAS)', '300hPa zg WAF (MJJAS)', f0.lon.data, f0.lat.data, ttest, levels/10)