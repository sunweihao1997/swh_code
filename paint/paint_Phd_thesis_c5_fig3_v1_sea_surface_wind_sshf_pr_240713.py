...
#    newcmp.set_over('#145DA0')
    ...
    for col in range(4):
        ...
        im2  =  ax.contourf(lon_trmm, lat_trmm, precip[t][j], np.linspace(1., 5.5, 10), cmap=newcmp, alpha=1,)
    ...
    plt.savefig('/home/sun/paint/phd/phd_C5_fig3_v1_climate_early_late_circulation_evolve_10mwind_pr_sshf_test.pdf')
# ============================================================================
...
# === Set time to paint ===
select_time = np.array([-20, -10, -5, -0])
number =  ["a","b","c","d","e"]
...
def main():
    ...
    # band-pass OLR
    select_timepr = np.array([-20, -10, -7, -0,])
