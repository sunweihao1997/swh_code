# -*- coding: utf-8 -*-
"""
Chongming 2022-09-01 ~ 2022-12-31
...
DATE_COL = "日期"
SAL_COL  = "盐度"     # 源数据为“盐度”
STATION_NAME = "chongming"    # 仅用于标题（英文小写）
STATION_CODE = "05454"
START = "2022-09-01 00:00:00"
END   = "2022-12-31 23:59:59"

# —— 阈值（原脚本的盐度阈值 0.45），这里自动换算成氯度阈值并画线 —— #
SAL_THRESHOLD = 0.45                               # 盐度阈值（可改）
CL_THRESHOLD  = SAL_THRESHOLD / 1.80655 * 1000     # ≈ 249 mg/L

OUT_PNG = "/mnt/f/wsl_plot/donghai/salinity/05454_chongming_Cl_20220901-20221231.png"
OUT_PDF = "/mnt/f/wsl_plot/donghai/salinity/05454_chongming_Cl_20220901-20221231.pdf"
# ========================
...
ax.xaxis.set_minor_locator(mdates.WeekdayLocator(byweekday=mdates.MO))  # 每周一次刻度
...
ax.set_title("ChongMing 2022.9.1–12.31 Chlorinity Time Series", fontsize=15, pad=10)
