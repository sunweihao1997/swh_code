...
def plot_change_wet_day(ssp, sspntcf, left_string, figname, lon, lat, parray, ct_level=np.linspace(-10., 10., 21),):
    ...
    # -------   cartopy extent  -----
    lonmin,lonmax,latmin,latmax  =  40,160,-30,30
...
if __name__ == '__main__':
    ...
    levels    =  np.array([-4, -3, -2, -1, -0.05, 0.05, 1, 2, 3, 4,])
    ...
    plot_change_wet_day(np.nanmean(ssp0, axis=0) * 1e3, np.nanmean(ntcf0, axis=0) * 1e3, '500hPa OMEGA', '500hPa OMEGA', f0.lon.data, f0.lat.data, ttest, levels)